...
namespace NS_A4963 {
    ...
    struct RegisterValues<A4963RegisterNames::BlankTime> {
        ...
        static constexpr auto normalizer = [](auto input) { return static_cast<type::value_type>(input / value.getPrecision()); };
    };
    ...
    struct RegisterValues<A4963RegisterNames::CurrentSenseThresholdVoltage> {
        ...
        static constexpr auto normalizer = [](auto input) { return (static_cast<type::value_type>(input / value.getPrecision()) - 1); };
    };
