...
namespace spi {
    ...
    public:
        ...
        virtual std::shared_ptr<SPIData> transfer(const SPIData& spiData)  = 0;
        virtual std::vector<std::shared_ptr<SPIData>> transfer(const std::initializer_list<std::shared_ptr<SPIData>>& spiData) = 0;
